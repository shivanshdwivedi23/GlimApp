...
class CustomAdapter(private var newsList: List<NewsModel>) :
    ...
    // Constructor to initialize click listeners
    constructor(newsList: List<NewsModel>, clickListener: OnItemClickListener, longClickListener: OnItemLongClickListener) : this(newsList) {
    ...
    fun setData(newData: List<NewsModel>) {
        newsList = newData.toMutableList()
